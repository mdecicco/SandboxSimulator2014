...
static void AddAssignCharStringGeneric(asIScriptGeneric * gen)
{
    char *a = static_cast<char*>(gen->GetAddressOfArg(0));
	string *self = static_cast<string*>(gen->GetObject());
...
void RegisterStdString_Generic(asIScriptEngine *engine)
{
	...
	// Automatic conversion from values
	r = engine->RegisterObjectMethod("string", "string &opAddAssign(char)", asFUNCTION(AddAssignCharStringGeneric), asCALL_GENERIC); assert( r >= 0 );
